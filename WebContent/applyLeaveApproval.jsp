...
<script src="js/leaveApply.js" type="text/javascript" ></script>
		...
		$.ajax({
			...
			success:function(data){
				if(data == "invalid employee number"){
					...
					disableAll();
				}else if(data == "acting person cant't be yourself"){
					changeProperty("leaveType",true);
					disableAll();
...
<s:if test="MP2001_NUM == '' || type == 'edit'" >
	                                    ...
	                                    <s:select id="workingHours1" name="workingHours1" list="workingHoursFromList" style="height:20px;" theme="simple" onchange="calcTime()" disabled="true"/>hour
	                                    <s:select id="workingMinute1" name="workingMinute1" list="workingMinuteList" style="height:20px;" theme="simple" onchange="calcTime()" disabled="true"/>minute
	                                    <s:fielderror theme="simple" cssStyle="color:red;margin-left:10px;">
...
<s:if test="MP2001_NUM == '' || type == 'edit'" >
	                                    ...
	                                    <s:select id="workingHours2" name="workingHours2" list="workingHoursToList" theme="simple" onchange="calcTime()" disabled="true"/>hour
	                                    <s:select id="workingMinute2" name="workingMinute2" list="workingMinuteList" style="height:20px;" theme="simple" onchange="calcTime()" disabled="true"/>minute
...
<s:else>
                            ...
                            <tr id="managerApproval">
                                ...
                                <td class="table_none">
                                    <input name="approval" value="${approval}" type="checkbox" style="display:none;"/>
				...
				<tr>
					<td class="menubar_button" id="button_0" align="center">
					    <s:submit name="Approval" value="Approve" align="left" method="approvalLeaveInfo" click="" theme="simple"/>
					    <s:submit name="notApproval" value="Not Approve" align="left" method="notApprovalLeaveInfo" onclick="" theme="simple"/>
