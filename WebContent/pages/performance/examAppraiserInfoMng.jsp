...
PageClick = function(pageclickednumber) {
    ...
    var param = {"pageNum" : pageclickednumber,"param1" : param1,"param2" : param2,"param3" : param3};
    document.getElementById("pageNum").value = pageclickednumber;
    $("#examAppraiserInfoListDiv").load("examAppraiserInfoPageClick.action",param);
}
</script>
<script type="text/javascript">
//局部刷新
function pageRefresh(){
    ...
    var param = {"pageNum" : _pageNum,"param1" : param1,"param2" : param2,"param3" : param3};
	$("#examAppraiserInfoListDiv").load("examAppraiserInfoPageClick.action",param);
}
function edit(id){
	var popstyle="dialogTop:200px;dialogLeft:300px;help:no;center:yes;dialogHeight:300px;dialogWidth:1000px;status:no;resizable:yes;scroll:no;loacation:no;toolbar:no;";
	window.showModalDialog("examAppraiserAddInit.action?pageType=edit&commonSeq=" + id,window,popstyle);
}
</script>

</head>
<body>
<s:form action="examAppraiserInfoSearch" method="post" theme="simple">
...
<table border='0' cellpadding='0' cellspacing='0' width='100%' align='center'>
	<tr>
		<td class='menubar_title' style="background-color:transparent;border:0;border-bottom:2px black solid;"><img border='0'src='images/icon/config.gif' align='absmiddle' hspace='3' vspace='3'>&nbsp;Appraiser Management</td>
...
<table width="100%" border="0" cellspacing="1" cellpadding="3" align="center" style="margin-top:5px;">
    ...
    <tr>
        ...
        <td width="30%"><s:select id="param3" name="param3" value="param3" list="commonDepartmentList" theme="simple"/></td>
        <td colspan="2" align="right"><input type="submit" name="searchBtn" value="Search" id="searchBtn" class="" <s:if test="optSearch == 0" >disabled="disabled"</s:if>/></td>
    </tr>
</table>
<!--检索区域End-->

<div id="examAppraiserInfoListDiv" style="border: 0px solid #000000;margin-top:20px;">
