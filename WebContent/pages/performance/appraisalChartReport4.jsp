...
function s(){
	...
	if(param1 == "" || param2 == ""){
		...
		_type.src="appraisalChartReport4.action?param1=" + param1 + "&param2=" + param2 + "&param3=" + param3 + "&param4=" + param4;
	}
}
function t(){
	var param3 = document.getElementById("param3").value;
	...
	window.showModalDialog("employeeSelectInit.action?pageType=appraisalReport&commonSeq=" + param3, window, popstyle);
}
</script>
</head>
<body>
...
<div style="float:left;width:100%;border:solid 0px black;margin-bottom:10px;">
    ...
    Employee Number: <input id="param4" name="param4" value="${param4}" type="text" />
    <input type="button" class="input0" name="addEmp" onclick="t()" value="Select..." />
...
<div style="float:left;width:100%;border:solid 0px black;">
    <img id="chartId" alt="jfreechart" src="appraisalChartReport4.action" /> 
</div>
