...
<div id='tabContent__0' style='display:block;'>
	<table cellpadding="2" cellspacing="1" border="0" width="100%" align="center">
		<tr>
			...
			<td	width="74%"	class=td1><s:property value="mp7004.MP7004_EMPLOYEE_NAME"/></td>
		</tr>
		<tr>
			<td	width="26%"	align="right" class=td1>Employee Name:</td>
			<td	width="74%"	class=td1><s:property value="mp7004.MP7004_EMPLOYEE_NUM"/></td>
		</tr>
		<tr>
			<td	width="26%"	align="right" class=td1>Department:</td>
			<td	width="74%"	class=td1><s:property value="mp7004.MP7004_DEPARTMENT_NAME"/></td>
		</tr>
		<tr>
			<td	width="26%"	align="right" class=td1>Designation:</td>
			<td	width="74%"	class=td1><s:property value="mp7004.MP7004_JOB_NAME"/></td>
		</tr>
		<tr>
			<td	width="26%"	align="right" class=td1>Manager:</td>
			<td	width="74%"	class=td1><s:property value="mp7004.MP7004_MANAGER_NAME"/></td>
		</tr>
		<tr>
			<td	width="26%"	align="right" class=td1>Review Period:</td>
			<td	width="74%"	class=td1><s:property value="mp7004.MP7004_REVIEW_PERIOD"/></td>
		</tr>
		<tr>
			<td	width="26%"	align="right" class=td1>Name of Appraiser:</td>
			<td	width="74%"	class=td1>
			    <input id="empName" name="mp7004.MP7004_APPRAISER_NAME" value="${mp7004.MP7004_APPRAISER_NAME}" type="text" style="border:none;" readonly="readonly"/>
			    <input id="empNum" name="mp7004.MP7004_APPRAISER" value="${mp7004.MP7004_APPRAISER}" type="text" style="border:none;" readonly="readonly"/>
			    <input type="button" onclick="selectEmployee()" value="Change Appraiser" />
			</td>
		</tr>
		<tr>
			<td	width="26%"	align="right" class=td1>Comment:</td>
			<td	width="74%"	class=td1><s:textarea id="qt" name="mp7004.MP7004_COMMENT" style="width:100%;height:60px;" theme="simple"></s:textarea></td>
		</tr>
	</table>
</div>
...
<s:iterator value="evaluationMonthlyScoresList" status="st">
		<tr id="<s:property value="MP7005_SEQ"/>" align="left" style="height:28px;background-color:green;" onmousedown="rowClick('<s:property value="MP7005_SEQ"/>')">
