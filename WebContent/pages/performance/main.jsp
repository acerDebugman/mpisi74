...
<tr>
	<td height="58" colspan="3">
	    <iframe frameborder="0" id="top" name="top" scrolling="no" src="pages/performance/top.jsp" style="height: 100%; visibility: inherit;width: 100%;"></iframe>
	</td>
</tr>
<tr>
...
<tr>
	<td align="middle" id="frmTitle" valign="top" name="fmtitle" style="background:#c9defa">
	    <iframe frameborder="0" id="frmleft" name="frmleft" src="pages/performance/left.jsp" style="height: 100%; visibility: inherit;width: 185px;background:url(images/skins2/leftop.gif) no-repeat" allowtransparency="true"></iframe>
	</td>
