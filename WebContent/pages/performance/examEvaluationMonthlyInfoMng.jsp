...
PageClick = function(pageclickednumber) {
    ...
    var param = {"pageNum" : pageclickednumber,"param1" : param1,"param2" : param2,"param3" : param3,"param4" : param4,"param5" : param5};
    document.getElementById("pageNum").value = pageclickednumber;
    $("#examEvaluationInfoListDiv").load("examEvaluationMonthlyInfoPageClick.action",param);
}
</script>
<script type="text/javascript">
//局部刷新
function pageRefresh(){
    ...
    var param = {"pageNum" : _pageNum,"param1" : param1,"param2" : param2,"param3" : param3,"param4" : param4,"param5" : param5};
	$("#examEvaluationInfoListDiv").load("examEvaluationMonthlyInfoPageClick.action",param);
}
function edit(id){
	...
	window.showModalDialog("examEvaluationMonthlyAddInit.action?pageType=edit&commonSeq=" + id,window,popstyle);
}
function Del(id){
	...
	if (confirm(msg)==true){
	    ...
	    var param5 = $("#param5").val();
		var _pageNum = document.getElementById("pageNum").value;
		var param = {"pageNum" : _pageNum,"commonSeq" : id,"param1" : param1,"param2" : param2,"param3" : param3,"param4" : param4,"param5" : param5};
		$("#examEvaluationInfoListDiv").load("examEvaluationMonthlyInfoDelete.action",param);
...
function ce(){
    ...
    var param3 = $("#param3").val();
    var param5 = $("#param5").val();
    var param = "?param1=" + param1 + "&param2=" + param2 + "&param3=" + param3 + "&param5=" + param5;
 	var options = {
	    url : "createMonthlyAppraisalFormInfoExcelDocument.action" + param,
	    type : "post",
        dataType : "html",
...
<body>
<form id="from1" name="from1" action="examEvaluationMonthlyInfoSearch" method="post" enctype="multipart/form-data">
...
<table width="100%" border="0" cellspacing="1" cellpadding="3" align="center" style="margin-top:5px;">
    <tr>
        <td width="20%">Employee Number/Surname/First Name</td>
    ...
    <tr>
        ...
        <td width="30%">
            <input id="param2" name="param2" value="${param2}" type="text" style="width:30%;"/>(YYYY-MM) ~ 
            <input id="param5" name="param5" value="${param5}" type="text" style="width:30%;"/>(YYYY-MM)
        </td>
    </tr>
    <tr>
