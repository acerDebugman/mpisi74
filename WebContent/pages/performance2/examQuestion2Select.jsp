...
PageClick = function(pageclickednumber) {
    ...
    $("#examQuestionInfoListDiv").load("examQuestion2SelectPageClick.action",param);
}
</script>
<script type="text/javascript">
function sel(id){
 	...
 	$.ajax({
		url:"examPlan2ItemInfoSave.action?param1=" + id + "&commonSeq=" + commonSeq,
		type:"post",
		dataType:"html",
		//data: params,
		error:function(ex){
		...
		success:function(ex){
			window.dialogArguments.document.getElementById('btnRefresh').click();
			alert(ex);
		}
	});
}
...
<s:iterator value="examQuestion2InfoList" status="st">
    <tr align="left" style="height:28px;">
        ...
        <td><s:property value="MP8001_TITLE2"/></td>
        <td width="50px"><s:property value="MP8001_STATUS_NAME"/>&nbsp;</td>
        <td width="50px" align="center">
            <input class="input0" type="button" onclick="sel('<s:property value="MP8001_SEQ"/>','<s:property value="MP8001_TITLE"/>')" name="selBtn" value="Select" id="selBtn"/>
        </td>
    </tr>
</s:iterator>
</table>
