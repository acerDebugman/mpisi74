...
PageClick = function(pageclickednumber) {
    ...
    $("#examQuestionInfoListDiv").load("examQuestion2InfoPageClick.action",param);
}
</script>
<script type="text/javascript">
//局部刷新
...
function edit(id){
	...
	window.showModalDialog("examQuestion2AddInit.action?pageType=edit&commonSeq=" + id,window,popstyle);
}
function Del(id){
	...
	if (confirm(msg)==true){
	    ...
	    var param2 = $("#param2").val();
		 ...
		 $("#examQuestionInfoListDiv").load("examQuestion2InfoDelete.action",param);
...
<body>
<s:form action="examQuestion2InfoSearch" method="post" theme="simple">
