...
<!-- 默认功能菜单 -->
	    <div id="left0" style="display:"> 
	    	<a href="examQuestion2AddInit.action?pageType=add" target="frmright">Add Appraisal Questionnaire</a>
	    	<a href="examQuestion2InfoMngInit.action" target="frmright">Appraisal Questionnaire</a>
	    </div>
<!-- 绩效考核题库管理菜单 -->
...
<!-- 绩效考核计划管理菜单 -->
	    <div id="left2" style="display:none"> 
	    	<a href="examPlan2AddInit.action?pageType=add" target="frmright">Add New Plan</a>
	    	<a href="examPlan2InfoMngInit.action" target="frmright">Appraisal Plan Management</a>
	    </div>
<!-- 月度绩效考核管理菜单 -->
	    <div id="left3" style="display:none">
	    	<a href="examEvaluationMonthly2InfoMngInit.action" target="frmright">Appraisal Form</a>  <!-- F0052001, EDIT page is F0052002 --> 
	    	<a href="examEvaluationMonthly2ReportMngInit.action" target="frmright">Appraisal Management</a> <!-- F0053001 -->
	    </div>
<!-- 年度绩效考核管理菜单 -->
	    <div id="left4" style="display:none"> 
	    	<a href="examEvaluationYearlyInfo2MngInit.action" target="frmright">Appraisal Management(Yearly)</a>
	    </div>
