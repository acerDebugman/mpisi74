...
PageClick = function(pageclickednumber) {
    ...
    $("#examPlanInfoListDiv").load("examPlan2InfoPageClick.action",param);
}
</script>
<script type="text/javascript">
//局部刷新
...
function edit(id){
	...
	window.showModalDialog("examPlan2AddInit.action?pageType=edit&commonSeq=" + id,window,popstyle);
}
function copy(id){
	...
	if (confirm(msg)==true){
		...
		$("#examPlanInfoListDiv").load("examPlan2InfoCopy.action",param);
...
function Del(id){
	...
	if (confirm(msg)==true){
		...
		var _pageNum = document.getElementById("pageNum").value;
		var param = {"pageNum" : _pageNum,"commonSeq" : id,"param1" : param1,"param2" : param2,"param3" : param3,"param4" : param4};
		$("#examPlanInfoListDiv").load("examPlan2InfoDelete.action",param);
...
function execute(id){
	...
	if (confirm(msg)==true){
		...
		var _pageNum = document.getElementById("pageNum").value;
		var param = {"pageNum" : _pageNum,"commonSeq" : id,"param1" : param1,"param2" : param2,"param3" : param3,"param4" : param4};
		$("#examPlanInfoListDiv").load("examPlan2InfoExecute.action",param);
...
<body>
<s:form action="examPlan2InfoSearch" method="post" theme="simple">
