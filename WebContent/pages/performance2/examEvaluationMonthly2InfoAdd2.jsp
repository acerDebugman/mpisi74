...
<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" style="margin-top:5px;">
	<tr align="center">
		<td	class="td1" colspan="3" style="color:red;">(5)=Exceptional (4)=Exceeds Requirements (3)=Meet Requirement (2)=Gets By (1)=Needs Work</td>
	</tr>
    <tr>
    ...
    <tr>
        <td width="20%"><s:property value="mp8005.MP8005_DEPARTMENT_NAME"/></td>
        <td width="20%"><s:property value="mp8005.MP8005_MANAGER_NAME"/></td>
        <td width="20%"><s:property value="mp8005.MP8005_REVIEW_PERIOD"/></td>
    </tr>
    <tr>
        <td colspan="3"><s:textarea id="qt" name="mp8005.MP8005_COMMENT" style="width:100%;height:60px;" theme="simple"></s:textarea></td>
    </tr>
    <tr>
        <td colspan="3">
	...
	<tr align="center">
		<td	class="td1" colspan="3"><input type="submit" class="button" name="Submit" value="Save"></td>
	</tr>
</table>
