...
PageClick = function(pageclickednumber) {
    ...
    $("#examQuestionSelectedItemListDiv").load("examQuestion2SelectMngPageClick.action",param);
}
</script>
<script type="text/javascript">
function Del(id, title){
	...
	if (confirm(msg)==true){
		...
		$("#examQuestionSelectedItemListDiv").load("examQuestion2SelectDelete.action",param);
