...
<body>
<s:form action="examQuestion2InfoSave" method="post" theme="simple">
...
<!--  	        <s:property value="errMsg"/> -->
	...
	<tr>
		...
		<td	width="74%"	class=td1>
		    <input name="mp8001.MP8001_TITLE" value="${mp8001.MP8001_TITLE}" type="text" style="width:80%;"/>  (Must Fill)
	        <s:fielderror theme="simple" cssStyle="color:red;margin-left:10px;">
	            <s:param>mp8001.MP8001_TITLE</s:param>
	        </s:fielderror>
		</td>
	</tr>
	<tr>
		<td	width="26%"	align="right" class=td1>Sub Name(Year):</td>
		<td	width="74%"	class=td1><s:textarea name="mp8001.MP8001_SUB_TITLE" style="width:99%;height:100px;" theme="simple"></s:textarea></td>
	</tr>
<s:if test="pageType == 'edit'">
	...
	<tr>
		...
		<td	width="74%"	class=td1><s:textarea name="mp8001.MP8001_COMMENT" style="width:99%;height:200px;" theme="simple"></s:textarea></td>
	</tr>
	<tr align="center">
