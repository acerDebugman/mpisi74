...
function excelDown(){
	var options = {
		url : "createBudgetExcelDocument2.action",
		type : "post",
		dataType : "script",
...
<body>
<form id="form2" name="form2" action="budgetInfoReportByAccYearMonthSearch.action" method="post" enctype="multipart/form-data">
...
<table cellspacing="1" border="0" style="background-color:White;border-width:0px;margin-top:5px;width:960px;">
...
<div id="departmentBudgetInfoDiv" style="height:600px;width:960px;border:0px solid red;overflow-y:scroll;">
...
<s:iterator id="mp4003InfoList" value="mp4003InfoList" status="st">
   <tr class="row">
       ...
       <td width="100px" align="center"><s:property value="MP4003_ACCOUNTING_NUM"/></td>
       <td width="200px" align="center"><s:property value="MP4003_ACCOUNTING_NUM_NAME"/></td>
...
<table cellspacing="1" border="0" style="background-color:White;border-width:0px;margin-top:0px;width:960px;">
    <tr class="row" align="center">
        <td colspan="5" width="670px" align="right"><s:property value="budgetAmount1"/></td>
        <td width="130px" align="right"><s:property value="budgetAmount3"/></td>
        <td width="137px" align="right"><s:property value="budgetAmount4"/></td>
    </tr>
</table>
