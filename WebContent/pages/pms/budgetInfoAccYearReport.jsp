...
<body>
<form id="form2" name="form2" action="budgetInfoReportByAccYearSearch.action" method="post">
...
<table cellspacing="1" border="0" style="background-color:White;border-width:0px;margin-top:5px;width:860px;">
...
<div id="departmentBudgetInfoDiv" style="height:600px;width:860px;border:0px solid red;overflow-y:scroll;">
