...
function outputFolderLink()
{
  if (this.hreference)
  {
    ...
    doc.write("<a>");
   if (this.id == 0)
    doc.write("<a href='javascript:clickOnFolder(&#39;"+this.desc+"&#39;,"+this.id+","+this.cid+")'>");
   else
    doc.write("<a href='javascript:clickOnFolder(&#39;"+this.desc+"&#39;,"+this.id+","+this.cid+")' class=FolderStyle>");
}
...
function drawItem(leftSide)
{
  ...
  if (this.link)
    doc.write("</a>");
  doc.write("</td><td valign=middle nowrap style='cursor:pointer' onclick='javascript:clickOnNodeSelect(&#39;"+this.desc+"&#39;,"+this.id+","+this.cid+")'>");
...
function clickOnNodeSelect(foldername,folderId,cid)
{
  //var clicked = indexOfEntries[folderId];
  xNowMove(foldername,cid);
  //if (!clicked.isOpen)
