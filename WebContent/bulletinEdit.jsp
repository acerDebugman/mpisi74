...
<body bgColor="#FFFFFF" topMargin="5">
	<div>
<s:form action="editBulletin" method="post" theme="simple">
			...
			<tr>
				<td>
					...
					<table border='0' cellpadding='0' cellspacing='0' width='100%'
						...
						<tr>
							<td height='27px' class='menubar_function_text'>Operation Function：Edit Bulletin</td>
							<td class='menubar_menu_td' align='right'>
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td class="menubar_button" id="button_0"><img border="0" align="texttop" src="images/ICON/Edit.gif">&nbsp;
										    <s:submit label="" value="Save" style="width:60px;"/>
										</td>
									</tr>
								</table></td>
						</tr>
