...
$(document).ready(function(){
	var _saveFlag = document.getElementById("saveFlag").value;

	if(_saveFlag == "true"){
		document.getElementById("educationAddBtn").disabled = false;
		document.getElementById("experienceAddBtn").disabled = false;
		document.getElementById("contactAddBtn").disabled = false;
		// 让保存按钮不可用
		document.getElementById("save1").disabled = true;
		document.getElementById("messageID").innerText = "Save Success";
	}else{
		document.getElementById("educationAddBtn").disabled = true;
		document.getElementById("experienceAddBtn").disabled = true;
		document.getElementById("contactAddBtn").disabled = true;
	}
});
function uploadFile(){
	...
	$(document).ready(function() {
		var options = {
			...
			success : function(msg) {
				alert(msg);
				if (msg != "undefined" && msg.indexOf("#") > 0) {
				    var data = msg.split("#");
					$("#tipDiv").html(data[0]);
					$("#showImage").html("<img width='80px' height='100px' src='<%=path%>/showImage.action?imageUrl="+data[1]+"'/>");
				} else {
				    $("#tipDiv").html(msg);
				}
		    }
...
<%-- function saveInfo(obj){
	if(obj == "save1"){
		//form2.action = "employeeAdd.action?saveType=1";
		//form2.submit();
		var options = {
		    url : "<%=path%>/employeeAdd.action?saveType=1",
			type : "post",
			dataType : "script",
			success : function(msg) {
				document.getElementById("educationAddBtn").disabled = false;
		    ...
		    error : function(msg){
		    	document.getElementById("messageID").innerText = "Save Failure:" + msg;
		    }
		};
		$("#form2").ajaxSubmit(options);
	}
...
<div>
<form id="form2" name="form2" action="employeeAdd" method="post" enctype="multipart/form-data">
    <input type="hidden" id="educationHidden" name="educationHidden" value="${educationHidden}"/>
    <input type="hidden" id="workHidden" name="workHidden" value="${workHidden}"/>
                                ...
                                <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                                    <tr>
                                        <td colspan="4" align="center">
                                            <span id="messageID" style="color:red; font-size:18pt; font-weight:bold;"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="table_body table_body_NoWidth">Employee Number<span class="errorcss">*</span></td>
                                        ...
                                        <td class="table_none table_none_NoWidth" style="" colspan="2" rowspan="3">
                                            <div id="tipDiv"></div>
                                    ...
                                    <tr>
                                        <td class="table_body table_body_NoWidth">ID/Passport Number<span class="errorcss">*</span></td>
                                        <td class="table_none table_none_NoWidth">
                                    ...
                                    <tr>
                                        <td class="table_body table_body_NoWidth">ID/Passport Surname<span class="errorcss">*</span></td>
                                        <td class="table_none table_none_NoWidth">
                                    ...
                                    <tr>
                                        <td class="table_body table_body_NoWidth">ID/Passport Firstname<span class="errorcss">*</span></td>
                                        <td class="table_none table_none_NoWidth">
                                        ...
                                        <td class="table_body table_body_NoWidth">Prefered Name<span class="errorcss">*</span></td>
                                        <td class="table_none table_none_NoWidth">
                                    ...
                                    <tr>
                                        <td class="table_body table_body_NoWidth">Employee Type<span class="errorcss">*</span></td>
                                        <td class="table_none table_none_NoWidth">
                                    ...
                                    <tr>
                                        <td class="table_body table_body_NoWidth">Department<span class="errorcss">*</span></td>
                                        <td class="table_none table_none_NoWidth">
					                        <input id="departmentID" name="mp1001.MP1001_DEPARTMENT_ID" value="${mp1001.MP1001_DEPARTMENT_ID}" type="hidden" />
					                        <input id="departmentName" name="mp1001.MP1001_DEPARTMENT_NAME" value="${mp1001.MP1001_DEPARTMENT_NAME}" type="text" class="" style="border:solid 0px;background-color:transparent" readonly="readonly" />
                                        ...
                                        <td class="table_body table_body_NoWidth">Job Title<span class="errorcss">*</span></td>
                                        <td class="table_none table_none_NoWidth">
                                            <div id="positionDiv">
                                                <s:select name="mp1001.MP1001_POSITION" value="mp1001.MP1001_POSITION" list="positionList" theme="simple"/>
                                            </div>
                                            <s:fielderror theme="simple" cssStyle="color:red;margin-left:10px;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="table_none table_none_NoWidth">
                                            <input name="mp1001.MP1001_PHYSICAL_ADDRESS" value="${mp1001.MP1001_PHYSICAL_ADDRESS}" type="text" class="text_input" style="width:100%;" />
                                        </td>
...
<s:if test="educationInfoList != null">
                                    <tr class="row" align="center" style="height:28px;">
                                        <td><s:property value="MP1002_INSTITUTION_TYPE"></s:property></td>
                                        <td><s:property value="MP1002_INSTITUTION_NAME"></s:property></td>
                                        <td><s:property value="MP1002_QUALIFICATION_LEV"></s:property></td>
