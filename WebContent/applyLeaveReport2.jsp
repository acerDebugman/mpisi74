				...
				<tr>
					<td>
						...
						<table border='0' cellpadding='0' cellspacing='0' width='100%' align='center'>
							...
							<tr>
								<td height='27px' class='menubar_function_text'>Operation Function: Leave Application Report</td>
			            ...
			            <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
			                <tr>
			                    <td class="table_body table_body_NoWidth">Year<span class="errorcss">*</span></td>
			                    <td class="table_none table_none_NoWidth"><input id="fromDate" name="fromDate" value="${fromDate}" type="text" class="text_input" /></td>
			                    <td class="table_body table_body_NoWidth">Month<span class="errorcss">*</span></td>
			                    <td class="table_none table_none_NoWidth"><s:select  id="toDate" name="toDate" list="commonMonthList" theme="simple"/></td>
			                </tr>
			                <tr>
<s:if test="optAll == 1 || optDepartment==1" >
			                    <td class="table_body table_body_NoWidth">Employee number</td>
			                    <td class="table_none table_none_NoWidth"><input id="employeeNum" name="employeeNum" value="${employeeNum}" type="text" class="text_input" /></td>
</s:if>
<s:else>
			                    <td></td>
			                    <td></td>
...
<s:if test="optAll == 1" >
			                    ...
			                    <td class="table_none table_none_NoWidth"><s:select  id="departmentID" name="departmentID" list="departmentInfoList" theme="simple"/></td>
</s:if>
			                </tr>
			                <tr>
...
<s:iterator value="leaveReportList2" status="st">
                    <tr class="row" align="center" style="height:28px;">
                        <td width="150px"><s:property value="MP2009_EMPLOYEE_NUM"></s:property></td>
                        <td width="200px"><s:property value="MP2009_EMPLOYEE_NAME"></s:property> <s:property value="MP1001_SURNAME"></s:property></td>
                        <td width="150px"><s:property value="MP2009_DEPARTMENT"></s:property></td>
                        
                        <td width="100px"><s:property value="MP2009_YEAR"></s:property></td>
                        <td width="100px"><s:property value="MP2009_MONTH"></s:property></td>
                        
                        <td width="100px"><s:property value="MP2009_ANNUAL_EXT"></s:property></td>
                        <td width="100px"><s:property value="MP2009_SICK_EXT"></s:property></td>
                        <td width="100px"><s:property value="MP2009_FAMILY_RESP_EXT"></s:property></td>
                        <td width="100px"><s:property value="MP2009_STUDY_EXT"></s:property></td>
                        <td width="100px"><s:property value="MP2009_MATERNITY_EXT"></s:property></td>
                        <td width="100px"><s:property value="MP2009_UNPAID_EXT"></s:property></td>
                        <td width="100px"><s:property value="MP2009_OFFICIAL_BUSINESS_EXT"></s:property></td>
                    </tr>
</s:iterator>
                </table>
</div>
