...
public class AC0009DAO   implements IAC0009DAO {
	...
	public void save(AC0009 ac0009) {
		if (ac0009 != null) {
			sf.getCurrentSession().save(ac0009);
		}
	}

	public void delete(AC0009 ac0009) {
		sf.getCurrentSession().delete(ac0009);
	}

	public AC0009 findById(String seq) {
		return (AC0009) sf.getCurrentSession().get("entity.AC0009", seq);
	}

	@SuppressWarnings("unchecked")
	public List<AC0009> findAll() {
		return sf.getCurrentSession().createQuery("from AC0009").list();
	}

	public void update(AC0009 ac0009) {
		sf.getCurrentSession().update(ac0009);
	}
