...
public class MP2001DAO   implements IMP2001DAO {
	...
	public void save(MP2001 mp2001) {
		if (mp2001 != null) {
			sf.getCurrentSession().save(mp2001);
		}
	}

	public void delete(MP2001 mp2001) {
		sf.getCurrentSession().delete(mp2001);
	}

	public MP2001 findById(String leaveNum) {
		return (MP2001) sf.getCurrentSession().get("entity.MP2001", leaveNum);
	}

	@SuppressWarnings("unchecked")
	public List<MP2001> findAll() {
		return sf.getCurrentSession().createQuery("from MP2001 where MP2001_STATUS = '0' ").list();
	}

	public void update(MP2001 mp2001) {
		sf.getCurrentSession().update(mp2001);
	}
...
//            }
			...
			List<MP2001> retList = new ArrayList<MP2001>();
			@SuppressWarnings("rawtypes")
			List temp = sf.getCurrentSession().createQuery(queryString.toString()).list();
