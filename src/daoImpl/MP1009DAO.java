...
public class MP1009DAO   implements IMP1009DAO{
	...
	public void save(MP1009 mp1009) {
		if (mp1009 != null) {
			sf.getCurrentSession().save(mp1009);
		}
	}

	public void delete(MP1009 mp1009) {
		sf.getCurrentSession().delete(mp1009);
	}

	public MP1009 findById(int _key) {
		return (MP1009) sf.getCurrentSession().get("entity.MP1009", _key);
	}

	@SuppressWarnings("unchecked")
	public List<MP1009> findAll() {
		return sf.getCurrentSession().createQuery("from MP1009 where 1=1 ").list();
	}

	public void update(MP1009 mp1009) {
		sf.getCurrentSession().update(mp1009);
	}
