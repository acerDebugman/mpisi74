...
public class AC0003DAO   implements IAC0003DAO {
	...
	public void save(AC0003 ac0003) {
		if (ac0003 != null) {
//			sf.getCurrentSession().save(ac0003);
			sf.getCurrentSession().save(ac0003);
		}
	}

	public void delete(AC0003 ac0003) {
//		sf.getCurrentSession().delete(ac0003);
		sf.getCurrentSession().delete(ac0003);
	}

	public AC0003 findById(String seq) {
//		return (AC0003) sf.getCurrentSession().get("entity.AC0003", seq);
		return (AC0003) sf.getCurrentSession().get("entity.AC0003", seq);
	}

	@SuppressWarnings("unchecked")
	public List<AC0003> findAll() {
//		return sf.getCurrentSession().find("from AC0003");
		return sf.getCurrentSession().createQuery("from AC0003").list();
	}

	public void update(AC0003 ac0003) {
		sf.getCurrentSession().update(ac0003);
	}
...
//			return sf.getCurrentSession().find(queryString, value);
