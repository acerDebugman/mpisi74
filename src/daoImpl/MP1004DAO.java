...
public class MP1004DAO   implements IMP1004DAO {
	...
	public void save(MP1004 mp1004) {
		if (mp1004 != null) {
			sf.getCurrentSession().save(mp1004);
		}
	}

	public void delete(MP1004 mp1004) {
		sf.getCurrentSession().delete(mp1004);
	}

	public MP1004 findById(String employeeNum) {
		return (MP1004) sf.getCurrentSession().get("entity.MP1004", employeeNum);
	}

	@SuppressWarnings("unchecked")
	public List<MP1004> findAll() {
		return sf.getCurrentSession().createQuery("from MP1004").list();
	}
	...
	public void update(MP1004 mp1004) {
		sf.getCurrentSession().update(mp1004);
	}
