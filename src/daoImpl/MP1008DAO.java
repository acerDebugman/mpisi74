...
public class MP1008DAO   implements IMP1008DAO{
	...
	public void save(MP1008 mp1008) {
		if (mp1008 != null) {
			sf.getCurrentSession().save(mp1008);
		}
	}

	public void delete(MP1008 mp1008) {
		sf.getCurrentSession().delete(mp1008);
	}

	public MP1008 findById(String _key) {
		return (MP1008) sf.getCurrentSession().get("entity.MP1008", _key);
	}

	@SuppressWarnings("unchecked")
	public List<MP1008> findAll() {
		return sf.getCurrentSession().createQuery("from MP1008 where 1=1 ").list();
	}

	public void update(MP1008 mp1008) {
		sf.getCurrentSession().update(mp1008);
	}
