...
public class MP2003DAO   implements IMP2003DAO {
	...
	public void save(MP2003 mp2003) {
		if (mp2003 != null) {
			sf.getCurrentSession().save(mp2003);
		}
	}

	public void delete(MP2003 mp2003) {
		sf.getCurrentSession().delete(mp2003);
	}

	public MP2003 findById(String employeeNum) {
		return (MP2003) sf.getCurrentSession().get("entity.MP2003", employeeNum);
	}

	@SuppressWarnings("unchecked")
	public List<MP2003> findAll() {
		return sf.getCurrentSession().createQuery("from MP2003").list();
	}

	public void update(MP2003 mp2003) {
		sf.getCurrentSession().update(mp2003);
	}
...
/*        	mp23.setMP2003_EMPLOYEE_NUM(entry.getKey().split("#@")[0]);
        	...
        	sf.getCurrentSession().save(mp23);*/
