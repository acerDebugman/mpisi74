...
public class MP4002DAO   implements IMP4002DAO{
	...
	public void save(MP4002 mp4002) {
		if(mp4002 != null){
			sf.getCurrentSession().save(mp4002);
		}
	}
	// 删除数据
	public void delete(MP4002 mp4002) {
		if(mp4002 != null){
			sf.getCurrentSession().delete(mp4002);
		}
	}
	// 根据KEY检索数据
	...
	public List<MP4002> findAll() {
		return sf.getCurrentSession().createQuery(" from MP4002 where 1=1 order by MP4002_NUM ").list();
	}
	// 更新数据
	public void update(MP4002 mp4002) {
		if(mp4002 != null){
			sf.getCurrentSession().update(mp4002);
		}
	}
	// 动态根据传入的参数，检索数据
