...
public class MP0011DAO   implements IMP0011DAO{
	...
	public void save(MP0011 mp0011) {
		if (mp0011 != null) {
			sf.getCurrentSession().save(mp0011);
		}
	}

	public void delete(MP0011 mp0011) {
		sf.getCurrentSession().delete(mp0011);
	}

	public MP0011 findById(String _key) {
		return (MP0011) sf.getCurrentSession().get("entity.MP0011", _key);
	}

	@SuppressWarnings("unchecked")
	public List<MP0011> findAll() {
		return sf.getCurrentSession().createQuery("from MP0011 where 1=1 ").list();
	}

	public void update(MP0011 mp0011) {
		sf.getCurrentSession().update(mp0011);
	}
