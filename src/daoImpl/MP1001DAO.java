...
public class MP1001DAO   implements IMP1001DAO {
	...
	public void save(MP1001 mp1001) {
		if (mp1001 != null) {
			sf.getCurrentSession().save(mp1001);
		}
	}
    // 删除数据
	public void delete(MP1001 mp1001) {
		sf.getCurrentSession().delete(mp1001);
	}
    // 根据关键字查询数据
	public MP1001 findById(String employeeNum) {
		return (MP1001) sf.getCurrentSession().get("entity.MP1001", employeeNum);
	}
    // 查询所有数据
	@SuppressWarnings("unchecked")
	public List<MP1001> findAll() {
		return sf.getCurrentSession().createQuery("from MP1001 where MP1001_STATUS = '1' or MP1001_STATUS = '2' ").list();
	}
	
	@SuppressWarnings("unchecked")
	public List<MP1001> findbyDepartmentId(String departmentID) {
		return sf.getCurrentSession().createQuery("from MP1001 where (MP1001_STATUS = '1' or MP1001_STATUS = '2') and MP1001_DEPARTMENT_ID = '" + departmentID + "' " ).list();
	}
	...
	public List<MP1001> findAllResign(String _start, String _finish){
		...
		//return sf.getCurrentSession().find("from MP1001 where MP1001_STATUS = '3' order by MP1001_RESIGN_DATE desc ");
	...
	public List<MP1001> findAllEmail(){
		return sf.getCurrentSession()
				 .createQuery("from MP1001 where 1=1 and MP1001_STATUS = '2' and MP1001_COMPANY_EMAIL is not NULL and MP1001_COMPANY_EMAIL <> '' ")
				 .list();
	}
    // 更新数据
	public void update(MP1001 mp1001) {
		sf.getCurrentSession().update(mp1001);
	}
	// 更新数据
...
//					}});
			...
			//return sf.getCurrentSession().find(queryString.toString());
