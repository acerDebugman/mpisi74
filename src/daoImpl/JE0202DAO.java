...
public class JE0202DAO   implements IJE0202DAO {
	...
	public void save(JE0202 je0202) {
		...
		if(null != je0202){
			sf.getCurrentSession().save(je0202);
		}
	}
	...
	public void delete(JE0202 je0202) {
		// TODO Auto-generated method stub
		if(null != je0202){
			sf.getCurrentSession().delete(je0202);
		}
	}
	...
	public JE0202 findByKey(String key) {
		// TODO Auto-generated method stub
		return (JE0202)sf.getCurrentSession().get("entity.JE0202", key);
	}

	@Override
	public JE0202 findByValue(String value) {
		// TODO Auto-generated method stub
		//return (JE0202)sf.getCurrentSession().get("entity.JE0202", value);
		return (JE0202)sf.getCurrentSession().createQuery(" from JE0202 where JE0202_VALUE='" + value + "'").uniqueResult();
	}
	...
	public JE0202 findByType(String type) {
		// TODO Auto-generated method stub
		//return (JE0202)sf.getCurrentSession().get("entity.JE0202", value);
		return (JE0202)sf.getCurrentSession().createQuery(" from JE0202 where JE0202_VALUE='" + type + "'").uniqueResult();
	}
	...
	public List<JE0202> findAll() {
		// TODO Auto-generated method stub
		return sf.getCurrentSession().createQuery("from JE0202").list();
	}

	@Override
	public void update(JE0202 je0202) {
		// TODO Auto-generated method stub
		sf.getCurrentSession().update(je0202);
	}
...
//			});
	...
	public int getAllRowsCount(){ //for page
		//Session session = sf.getCurrentSession().getSessionFactory().getCurrentSession();
