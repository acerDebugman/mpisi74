...
public class AC0006DAO   implements IAC0006DAO {
	...
	public void save(AC0006 ac0006) {
		if (ac0006 != null) {
			sf.getCurrentSession().save(ac0006);
		}
	}

	public void delete(AC0006 ac0006) {
		sf.getCurrentSession().delete(ac0006);
	}

	public AC0006 findById(String seq) {
		return (AC0006) sf.getCurrentSession().get("entity.AC0006", seq);
	}

	@SuppressWarnings("unchecked")
	public List<AC0006> findAll() {
		return sf.getCurrentSession().createQuery("from AC0006").list();
	}

	public void update(AC0006 ac0006) {
		sf.getCurrentSession().update(ac0006);
	}
...
//		finally{ //session is managed by Transaction Manager
