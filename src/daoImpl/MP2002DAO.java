...
public class MP2002DAO   implements IMP2002DAO {
	...
	public void save(MP2002 mp2002) {
		if (mp2002 != null) {
			sf.getCurrentSession().save(mp2002);
		}
	}

	public void delete(MP2002 mp2002) {
		sf.getCurrentSession().delete(mp2002);
	}

	@SuppressWarnings("unchecked")
	public MP2002 findById(String employeeNum) {
		//return (MP2002) sf.getCurrentSession().get("entity.MP2002", employeeNum);
		try{
...
//			session.close();
	...
	public List<MP2002> findAll() {
		return sf.getCurrentSession().createQuery("from MP2002").list();
	}

	public void update(MP2002 mp2002) {
		sf.getCurrentSession().update(mp2002);
	}
