...
public class MP0002DAO   implements IMP0002DAO{
	...
	public void save(MP0002 mp0002) {
		if (mp0002 != null) {
			sf.getCurrentSession().save(mp0002);
		}
	}

	public void delete(MP0002 mp0002) {
		sf.getCurrentSession().delete(mp0002);
	}

	public MP0002 findById(int seq) {
		return (MP0002) sf.getCurrentSession().get("entity.MP0002", seq);
	}
	...
	public List<MP0002> findAll(boolean flag) {
		...
		return sf.getCurrentSession().createQuery(sql).list();
	}

	public void update(MP0002 mp0002) {
		sf.getCurrentSession().update(mp0002);
	}
