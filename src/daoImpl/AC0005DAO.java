...
public class AC0005DAO   implements IAC0005DAO {
	...
	public void save(AC0005 ac0005) {
		if (ac0005 != null) {
			sf.getCurrentSession().save(ac0005);
		}
	}

	public void delete(AC0005 ac0005) {
		sf.getCurrentSession().delete(ac0005);
	}

	public AC0005 findById(String seq) {
		return (AC0005) sf.getCurrentSession().get("entity.AC0005", seq);
	}

	@SuppressWarnings("unchecked")
	public List<AC0005> findAll() {
		return sf.getCurrentSession().createQuery("from AC0005").list();
	}

	public void update(AC0005 ac0005) {
		sf.getCurrentSession().update(ac0005);
	}
