...
public class MP7008DAO   implements IMP7008DAO{
	...
	public void save(MP7008 mp7008) {
		if(mp7008 != null){
			sf.getCurrentSession().save(mp7008);
		}
	}
	// 删除数据
	public void delete(MP7008 mp7008) {
		if(mp7008 != null){
			sf.getCurrentSession().delete(mp7008);
		}
	}
	// 根据KEY检索数据
	public MP7008 findById(String key) {
		return (MP7008)sf.getCurrentSession().get("entity.MP7008", key);
	}
	// 取得所有有效数据
	@SuppressWarnings("unchecked")
	public List<MP7008> findAll() {
		return sf.getCurrentSession().createQuery(" from MP7008 where 1=1  ").list();
	}
	// 更新数据
	public void update(MP7008 mp7008) {
		if(mp7008 != null){
			sf.getCurrentSession().update(mp7008);
		}
	}
	// 更新数据
