...
public class AC0002DAO   implements IAC0002DAO {
	...
	public void save(AC0002 ac0002) {
		if (ac0002 != null) {
//			sf.getCurrentSession().save(ac0002);
			sf.getCurrentSession().save(ac0002);
		}
	}

	public void delete(AC0002 ac0002) {
//		sf.getCurrentSession().delete(ac0002);
		sf.getCurrentSession().delete(ac0002);
	}

	public AC0002 findById(String seq) {
//		return (AC0002) sf.getCurrentSession().get("entity.AC0002", seq);
		return (AC0002) sf.getCurrentSession().get("entity.AC0002", seq);
	}

	@SuppressWarnings("unchecked")
	public List<AC0002> findAll() {
//		return sf.getCurrentSession().find("from AC0002");
		return sf.getCurrentSession().createQuery("from AC0002").list();
	}

	public void update(AC0002 ac0002) {
//		sf.getCurrentSession().update(ac0002);
		sf.getCurrentSession().update(ac0002);
	}
